...
import 'package:piecyk/widgets/circular_chart.dart';
import 'package:piecyk/widgets/vertical_device_list.dart'; // Import the circular chart
    ...
    child: LayoutBuilder(
      builder: (context, constraints) {
        return FResizable(
          ...
          crossAxisExtent: constraints.maxWidth / 3, // changed
          children: [
            FResizableRegion(
